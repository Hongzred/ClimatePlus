...
//        RadioGroup radiogroup;
        ...
        else if (changeBackground.equals("M"))
            changeCityLayout.setBackgroundResource((R.drawable.lines));
        else if (changeBackground.equals("N"))
            changeCityLayout.setBackgroundResource((R.drawable.snow));
        else if (changeBackground.equals("K"))
            changeCityLayout.setBackgroundResource((R.drawable.light));
        else if (changeBackground.equals("K"))
            changeCityLayout.setBackgroundResource((R.drawable.weather_background));
...
//                mWeatherImage.setImageResource(resourceID);
                ...
                String[] Letters = {"T", "M", "N", "K","L"};

                changeBackground = Letters[index[0]];
                if (changeBackground.equals("T"))
                    changeCityLayout.setBackgroundResource((R.drawable.birdsbackground));
                else if (changeBackground.equals("M"))
                    changeCityLayout.setBackgroundResource((R.drawable.lines));
                    ...
                    changeCityLayout.setBackgroundResource((R.drawable.light));
                else if (changeBackground.equals("L"))
                    changeCityLayout.setBackgroundResource((R.drawable.weather_background));
                index[0]++;
                if(index[0] == 5)
                    index[0] = 0;
