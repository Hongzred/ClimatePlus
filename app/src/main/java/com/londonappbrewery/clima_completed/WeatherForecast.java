...
//                startActivity(new Intent(WeatherForecast.this, WeatherController.class));
        ...
        if (background.equals("T"))
            ...
            forecastLayout.setBackgroundResource((R.drawable.lines));
        else if (background.equals("N"))
            forecastLayout.setBackgroundResource((R.drawable.snow));
        else if (background.equals("K"))
            forecastLayout.setBackgroundResource((R.drawable.light));
        else if (background.equals("L"))
            forecastLayout.setBackgroundResource((R.drawable.weather_background));
